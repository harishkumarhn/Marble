...
CREATE TABLE [dbo].[PaymentModes](
	...
	[isCreditCard] [char](1) NOT NULL,
	[CreditCardSurchargePercentage] [numeric](8, 2) NULL,
	[Guid] [uniqueidentifier] NULL,
	[SynchStatus] [bit] NULL,
	[SiteId] [int] NULL,
	[isCash] [char](1) NULL,
	[isDebitCard] [char](1) NULL,
	[Gateway] [int] NULL,
	[ManagerApprovalRequired] [char](1) NULL,
	[isRoundOff] [char](1) NULL,
