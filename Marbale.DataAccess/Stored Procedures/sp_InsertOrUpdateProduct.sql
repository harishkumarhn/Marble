USE [Marbale]
GO
/****** Object:  StoredProcedure [dbo].[sp_InsertOrUpdateProduct]    Script Date: 8/11/2019 4:43:13 AM ******/
SET ANSI_NULLS ON
GO
...
@LastUpdatedDate,@Games,@CreditsPlus,@Credits,@CardValidFor,@Courtesy,@finalPrice)      
end      
else      
begin      
 update Product set [Name]= @name,[Type]=@type,[Active]=@active,Price=@price,FinalPrice=@finalPrice,      
  ...
  Credits=@Credits,CardValidFor=@CardValidFor , Courtesy=@Courtesy  
